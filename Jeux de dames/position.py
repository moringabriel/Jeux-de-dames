...
if __name__ == '__main__':
    ...
    assert Position(1, 2) in position.positions_diagonales_haut() and Position(1, 4)\
           in position.positions_diagonales_haut()

    assert Position(1, 2) in position.quatre_positions_diagonales()\
           and Position(1, 4) in position.quatre_positions_diagonales()\
           and Position(3, 2) in position.quatre_positions_diagonales()\
           and Position (3, 4) in position.quatre_positions_diagonales()

    assert Position(0, 1) in position.quatre_positions_sauts() \
           and Position(0, 5) in position.quatre_positions_sauts() \
           and Position(4, 1) in position.quatre_positions_sauts() \
           and Position(4, 5) in position.quatre_positions_sauts()
